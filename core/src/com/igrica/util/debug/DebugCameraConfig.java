...
public class DebugCameraConfig {
    ...
    //kljucevi iz kljuc-vrednost mape/tabele
    ...
    static final String FILE_PATH = "debug/debugCameraConfig.json";
    ...
    //proveravanje da li json postoji
    private void init(){
        ...
        if(fileHandle.exists()){
            ...
            log.info("Default file doesn't exist= " + FILE_PATH);
            setUpDefaults();
        }
    }
    ...
    public boolean isLogPressed(){return Gdx.input.isKeyPressed(leftKey); }
    ...
    //izvlaci se string iz mape kluc-vrednost json-a ako postoji, ako ne uzima se default
