...
public class GameConfig {
    ...
    //deklarisanje svih konstanti vezanih za igrcu kao sto su
    //sirna ekrana, duzina, brzina kretanje igraca itd...
    public static final float WIDTH = 480f;
    public static final float HEIGHT = 800f;

    public static final float HUD_WIDHT = 480f;
    ...
    public static final float PLAYER_BOUNDS_RADIUS = 0.4f; //jedinice igrice
    public static final float PLAYER_SIZE = 2 * PLAYER_BOUNDS_RADIUS;

    public static final float OBSTACLE_BOUNDS_RADIUS = 0.3f; //jedinice igrice
